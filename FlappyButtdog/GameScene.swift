...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    // MARK: - Constants
    private let flapImpulse: CGFloat  = 88.96
    ...
    private func setupButtdog() {
        ...
        // Match the exact mass of the original circle hitbox so flapImpulse/gravity feel identical.
        body.mass = SKPhysicsBody(circleOfRadius: 28).mass
